...
export const ui = {
	en: {
		...
		'edu.uni.degree': 'Master of Science in Media Computer Science (On hold)',
		'edu.uni.date': 'Dec 2022 - Nov 2023',
		'edu.oth': 'University of Applied Sciences of Regensburg',
		'edu.oth.degree': 'Bachelor of Science in Computer Science',
		...
		'projects.fs.title': 'Frontstart - React Trainign',
		'projects.fs.text':
